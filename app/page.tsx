      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold mb-4">Prueba la Aplicación</h3>
            <p className="text-lg text-muted-foreground">Explora todas las funcionalidades con datos de ejemplo</p>
          </div>
